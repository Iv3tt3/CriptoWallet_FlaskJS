...
function display_purchase_resume(){
...
function execute_purchase(event){
    ...
    let validation = validate_datachanges_in_calculator()
...
function validate_datachanges_in_calculator(){
    ...
    if (first_click){
        ...
        let amount_from = document.querySelector("#Amount_From").value 
        let data_amount_from = last_calcul_data.Amount_From 
        if (amount_from != data_amount_from){
            alert("The data in calculator is different from the purchase resume. Please check your Purchase Resume.\nIf it is correct press again Purchase.\nIf it is not correct press Calcul")
            validation = false
        }

        let from_coin = document.querySelector("#From_Coin").value 
        let data_from_coin = last_calcul_data.From_Coin
        if (from_coin != data_from_coin){
            alert("The data in calculator is different from the purchase resume. Please check your Purchase Resume.\nIf it is correct press again Purchase.\nIf it is not correct press Calcul")
            validation = false
        }
        ...
        let to_coin = document.querySelector("#To_Coin").value 
        let data_to_coin = last_calcul_data.To_Coin
        if (to_coin != data_to_coin){
            alert("The data in calculator is different from the purchase resume. Please check your Purchase Resume.\nIf it is correct press again Purchase.\nIf it is not correct press Calcul")
            validation = false
        }
